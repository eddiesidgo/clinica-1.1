        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @role('secre')
                    <div class="d-flex justify-content-center">
                        <div class="secre-section mt-4 text-center">
                    ...
                    @role('doctor')
                    <div class="d-flex justify-content-center">
                        <div class="doctor-section mt-4 text-center">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><a href="{{ route('expedientes.index') }}">Expedientes de los pacientes</a></li>
                            </ul>
                        </div>
                    </div>
                    @endrole
